    ...
    <div>
      <section class="bg-white dark:bg-gray-900">
        <div class="container flex items-center py-16 justify-center min-h-screen px-6 mx-auto">
          <form class="w-full max-w-md shadow-lg shadow-yellow-200 ">
            ...
            <h3 class="text-lg font-medium text-gray-700 mt-6 uppercase text-center">
              <strong>Guarantor Form</strong>
            </h3>
            ...
            <div class="col-span-6 mt-4 pr-2 pl-2">
